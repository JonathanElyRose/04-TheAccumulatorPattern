...
def run_test_factorial():
    ...
    # Test 4:
    answer_from_oracle = math.factorial(58697)
    answer_from_my_code = factorial(58697)
    print('Test 4 expected (from oracle):', answer_from_oracle)
    print('        actual (from my code):', answer_from_my_code)

    # Test 5:
    answer_from_by_hand = 3628800
...
def run_test_count_cosines_from():
    ...
    # Test 2:
    expected = 7
    answer = count_cosines_from(5, 15, 0)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    # Test 3:
    expected = 6
    answer = count_cosines_from(22, 31, 0.3)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    # Test 4:
    expected = 6
    answer = count_cosines_from(-100, -95, -1)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 5
    answer = count_cosines_from(1, 12, 0)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    # Test 6:
    expected = 3
    answer = count_cosines_from(0, 5, -0.3)
...
def run_test_sum_unit_fractions_from():
    ...
    # Test 2:
    expected = -2.450000000  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(-6, -1)
    print('Test 2 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    # Test 3:
    expected = .2795106639  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(16, 20)
