...
def run_test_sum_more_cosines():
    ...
    # Test 2:
    expected = -.4174477460  # This is APPROXIMATELY the correct answer.
    ...
    # Test 3:
    expected = -1.235818462  # This is APPROXIMATELY the correct answer.
...
def run_test_count_sines_from():
    ...
    # Test 4:
    expected = 6
    answer = count_sines_from(-60, -52)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    # Test 5:
    expected = 5
    answer = count_sines_from(400, 406)
